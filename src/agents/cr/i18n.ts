...
export class I18nAgent extends BaseAgent<Issue> {
  constructor(openai: OpenAIClient, projectContextPrompt?: string) {
    super(openai, {
      name: 'i18n',
      promptPath: getProjectPath('src/prompts/cr/i18n.md'),
      description: '审查国际化相关问题',
  ...
  async execute(context: {
    ...
    try {
      ...
      logger.error('I18nAgent failed', { error });
